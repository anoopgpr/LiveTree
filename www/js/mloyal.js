...
var json_fb='https://taghash.co/mloyalApps/facebookwindmills.php';
var RSS_twitter='https://taghash.co/mloyalApps/twitter.php?uname=windmills';
var RSS_pinterest='http://103.25.128.61/projects/taghash/mloyalApps/pinteresttantra.php?brand=windmills';
var RSS_instagram='https://www.instagram.com/windmills/?__a=1';
var RSS_youtube='http://xceedfbapps.com/mloyalfeeds/youtube.php?brandname=windmills';
var RSS_tumblr='http://xceedfbapps.com/mloyalfeeds/tumblr.php?brandurl=http://windmills.tumblr.com';

var brandname='windmills';
var aboutus_det='windmills';
var brand_url='http://www.windmillscraftworks.com/';
var cart = { cartdata: []};
...
var SERVER = "https://totalenvironmentloyaltyprogram.mloyalretail.com/m/";
var SERVER1 = "https://totalenvironmentloyaltyprogram.mloyalretail.com/";
var PHPSERVER = "https://taghash.co/mloyalshops/windmills/";
...
$(document).ready(function(event){
                ...
                $( function() {
                     ...
                     /*$( "#mtype_colorpoup1" ).enhanceWithin().popup();
					 $( "#mtype_colorpoup2" ).enhanceWithin().popup();
					 $( "#mtype_colorpoup3" ).enhanceWithin().popup();*/
				});
				...
				$('input[type=radio][name=sel_membership]').change(function() {
					if (this.value == 'green') {
						showpopupColor('green');
					}
					else if (this.value == 'orange') {
						showpopupColor('orange');
					}
			   ...
			   if($.mobile.activePage.is('#homepage')){
                 ...
                 //getContacts();
                  if(localStorage.getItem("usernamewindmills")!=null && localStorage.getItem("usernamewindmills")!='' && localStorage.getItem("passwordwindmills")!=null && localStorage.getItem("passwordwindmills")!='')
                    {
                            $('#username').val(localStorage.getItem("usernamewindmills"));
                            $('#password_myacc').val(localStorage.getItem("passwordwindmills"));
							user.mobile = localStorage.getItem('usernamewindmills');
							var pwd = localStorage.getItem('passwordwindmills');
                        ...
                        if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
                           ...
                           // alert(user.firstname);
                            ...
                            document.getElementById("profilepts1").innerHTML=user.total+' points';
                             ...
                             $("#wait").css("display","none");
                             authenticate();
                          if(imageExists('https://taghash.co/mloyalfileupload/uploads/windmills_'+localStorage.getItem("usernamewindmills")+'.jpg'))
                          {
                              document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/windmills_'+localStorage.getItem("usernamewindmills")+'.jpg';
                          }                     
                     }
				   else if(localStorage.getItem("usernamewindmills")!=null && localStorage.getItem("usernamewindmills")!='' && (localStorage.getItem("passwordwindmills")==null || localStorage.getItem("passwordwindmills")=='')) 
	                 {
			...
			success: function(data, textStatus, xhr) {
			 ...
			 //if(data.toLowerCase()=='success'){
				 ...
				 toast('Passcode has been sent to your mobile.Please check your SMS.');
				  ...
				  localStorage.setItem('usernamewindmills',mob);
...
$(document).on('pageshow', '#homepage', function (event, ui) {
	...
	if(user.membership_slab=='Blue Membership')
	{
...
$(document).on('pageshow', '#topupmembership', function (event, ui) {

    document.getElementById('topup_denomination').selectedIndex= 0;
				    //$("#topup_denomination").selectmenu('refresh');
...
$(document).on('pageinit', '#homepage', function (event, ui) {
	...
	if(user.firstname=='undefined' || user.firstname=='null' || user.firstname==null || user.firstname==''){
		...
		if(parseInt(user.balance)<=10000){
			document.getElementById("category_img").src="img/star_main_img.png";
		}
...
function authenticate(){
 ...
 if(uname=='' || pwd==''){
  ...
  $.ajax({
   ...
   if(data.status=='success'){
	...
	user.membership_slab = data.membership_slab;
   ...
   localStorage.setItem('usernamewindmills',uname);
   localStorage.setItem('passwordwindmills',pwd);
 ...
 if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
    ...
    {
	    if(localStorage.getItem("profiledone_windmills")){
	...
	user.mobile = localStorage.getItem('usernamewindmills');
	pwd = localStorage.getItem('passwordwindmills');
	uname = user.mobile;
    user.balance = localStorage.getItem('balance');
    user.firstname = localStorage.getItem('firstname');
    user.lastname = localStorage.getItem('lastname');
...
$(document).on('pageinit', '#profilepage', function (event, ui) {
	...
	$.ajax({
			...
			success: function(data, textStatus, xhr) {
				...
				localStorage.setItem("profiledone_windmills","Yes");
...
function showInbox(){
	...
	showTabContent2('inbox', 'msg_history_json.asp');
	}
}
...
function showRewards(){
	...
	openInWebView('https://totalenvironmentloyaltyprogram.mloyalretail.com/microsite/');
	//RewardsNA();
	/*
	if(user.mobile==null || user.mobile=='')
	{
...
function showEvents()
{
	...
	var url = 'https://www.total-environment.com/music-and-events';

	var ref = window.open(url, '_blank');

	//var url='https://www.windmillscraftworks.com/#music';
...
{
	$.mobile.changePage( "#socialmain", { transition: "none"} ); 
...
function showPromotions()
{
	...
	showTabContent2('specials', 'specials_json.asp');
	}
...
function showTabContent_Map(addr,ind,storloc) {
var url="https://taghash.co/latlong.php";
...
function drawMap_byadd(sloc,index) 
{
    var str='';
	var add='';

    //add='Windmills '+sloc;
	var url ="https://maps.google.com/maps?output=embed&q=" + sloc;
	
	str+='<iframe width="400" height="300" frameborder="0" style="border:0;" src="'+url+'"></iframe>';

    $('#map-canvas'+index).html(str);
...
if(id=='rewardstore' || id=='reward-cat' || id=='reward-brand')
	{
	tabserver = "https://totalenvironmentloyaltyprogram.mloyalretail.com/Rewards/";
	}
else
	{
	
	tabserver = "https://totalenvironmentloyaltyprogram.mloyalretail.com/m/";
	}
...
function showTabContent2(id, url) {
console.log("url:"+url);
var tabserver='';
if(id=='rewardstore' || id=='reward-cat' || id=='reward-brand')
	{
...
function renderTemplate(pageID, json) {
	...
	case 'specials':
		...
		if(json.length == 0)
		{
			str = 'No specials/promotions Found';
		}
		else
		{
	...
	case 'inbox':
        ...
        str += '<span class="msghdr">DM-LIVTRU</span><span class="msgTime">'+json[i].msgtime+'</span>';
  ...
  for (var i=0;i<json.length;i++ )
  {
   ...
   continue;
      ...
      //showTabContent_Map(json[i].storeaddress,i,json[i].storelocation);
	  drawMap_byadd(json[i].storeaddress,i);
  }
...
var str = '';
	...
	switch (pageID) {
		...
		case 'aboutus':
			...
			//console.log('membership_slab: '+user.membership_slab);

			var mcls = document.getElementById("y_card_div").classList;

			if(user.membership_slab=='New Membership' || user.membership_slab=='')
			{
				console.log('New Member');

				if (mcls.contains("y_card_black")) 
				{
					mcls.remove("y_card_black");
				}
				if (mcls.contains("y_card_green")) 
				{
					mcls.remove("y_card_green");
				}
				if (mcls.contains("y_card_orange")) 
				{
					mcls.remove("y_card_orange");
				}
				if (mcls.contains("y_card_blue")) 
				{
					mcls.remove("y_card_blue");
				}
				if (mcls.contains("y_card_purple")) 
				{
					mcls.remove("y_card_purple");
				}
				if (mcls.contains("y_card_family")) 
				{
					mcls.remove("y_card_family");
				}
				
				mcls.add("y_card_black");
				document.getElementById("mType").innerHTML = 'New Member';

			}
			else if(user.membership_slab=='Green Membership')
			{
				console.log('Green Member');
				...
				mcls.add("y_card_green");
				document.getElementById("mType").innerHTML = 'Green Member';

			}
			else if(user.membership_slab=='Orange Membership')
			{
				console.log('Orange Member');
				...
				mcls.add("y_card_orange");
				document.getElementById("mType").innerHTML = 'Orange Member';

			}
			else if(user.membership_slab=='Blue Membership')
			{
				console.log('Blue Member');
				...
				mcls.add("y_card_blue");
				document.getElementById("mType").innerHTML = 'Blue Member';

			}
			else if(user.membership_slab=='Purple Membership')
			{
				console.log('Purple Member');
				...
				mcls.add("y_card_purple");
				document.getElementById("mType").innerHTML = 'Purple Member';

			}
			else if(user.membership_slab=='Family Membership')
			{
				...
				mcls.add("y_card_family");
				document.getElementById("mType").innerHTML = 'Family Member';

			}

			/*if(parseInt(user.balance)>=0 && parseInt(user.balance)<=1200)
            {
            ...
            else if(parseInt(user.balance)>=1201 && parseInt(user.balance)<=4000)
            {
               document.getElementById('silverslab').className = '';
               document.getElementById('goldslab').className = '';
		       document.getElementById('platinumslab').className = '';
            ...
            else if(parseInt(user.balance)>=4001)
            {
               document.getElementById('silverslab').className = '';
               document.getElementById('goldslab').className = '';
		       document.getElementById('platinumslab').className = '';
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json);
          ...
          localStorage.setItem('facebook_windmills',JSON.stringify(json.item));
		 ...
		 try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('facebook_windmills')));
		 }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.feed.entry);
          ...
          localStorage.setItem('youtube_windmills',JSON.stringify(json.feed.entry));
		   ...
		   try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('youtube_windmills')));
		   }
		   catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
...
else if(url==RSS_twitter)
{
  ...
  $.ajax({
            ...
            localStorage.setItem('twitter_windmills', JSON.stringify(data));
                },
                error: function (xhr, textStatus, errorThrown) {
				...
				{
					renderTemplate(id, JSON.parse(localStorage.getItem('twitter_windmills')));
					//alert('here in catch');
				}
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.body);
          ...
          localStorage.setItem('pinterest_windmills',JSON.stringify(json.body));
		   ...
		   try{
			    renderTemplate(id,JSON.parse(localStorage.getItem('pinterest_windmills')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_tumblr)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('tumblr_windmills',JSON.stringify(json.channel.item));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('tumblr_windmills')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_instagram)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('instagram_windmills',JSON.stringify(json.user));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('instagram_windmills')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
function receivedEvent(id) {
 ...
 var push = PushNotification.init({ "android": {"senderID": "229018021693"}});
...
function addincart(i)
{
	...
	cart.cartdata.push({ 
   "index":i,
   "url" : "https://totalenvironmentloyaltyprogram.mloyalretail.com/"+jsonary[i].brand_logo,
...
function checkout(){
  ...
  $.ajax({
    url: 'https://totalenvironmentloyaltyprogram.mloyalretail.com/Rewards/complete.asp',
    type: 'GET',
    timeout: 50000,
...
function giftfriend(){
  ...
  var val=$('#giftpt').val();
  $.ajax({
    url: 'https://totalenvironmentloyaltyprogram.mloyalretail.com/m/gift_points_api.asp',
    type: 'GET',
    timeout: 50000,
    dataType: 'text', //xml/html/script/json/jsonp
...
function shareApp()
{
	window.plugins.socialsharing.share('Hi, Join Live True Program', null, 'https://taghash.co/shareimg/windmills.jpg', 'https://totalenvironmentloyaltyprogram.mloyalretail.com/mapp');
}
...
function rateApp()
{
	var deviceType = (navigator.userAgent.match(/iPad/i))  == "iPad" ? "iPad" : (navigator.userAgent.match(/iPhone/i))  == "iPhone" ? "iPhone" : (navigator.userAgent.match(/Android/i)) == "Android" ? "Android" : (navigator.userAgent.match(/BlackBerry/i)) == "BlackBerry" ? "BlackBerry" : "null";
		 if (deviceType=='iPad' || deviceType=='iPhone') 
			 ...
			 {
               window.open("market://details?id=com.mobiquest.windmills","_system");
...
function showSocial(id)
{
	...
	if(id=='1')
	{
		$.mobile.changePage( "#social_fb", { transition: "none"} );
	}
	else if(id=='2')
	{
		$.mobile.changePage( "#social_insta", { transition: "none"} );
	}
	else if(id=='3')
	{
		$.mobile.changePage( "#social_twitter", { transition: "none"} );
	}
...
function showShop()
{
	...
	$.mobile.changePage( "#reservationpg", { transition: "none"} );

    //openInWebView('https://www.windmillscraftworks.com/reservation/');

	//var url='https://www.windmillscraftworks.com/reservation/';
	//window.open("googlechrome://navigate?url=" + url,"_system");
...
var toast2 = function (msg) {
    $("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h5>" + msg + "</h5></div>")
            .css({display: "block",
                ...
                left: ($(window).width() - 284) / 2,
                top: $(window).height() / 2})
            .appendTo($.mobile.pageContainer).delay(3200)
...
$("input[type=file]").change(function(){
  ...
  // alert($("input[type=file]")[0].files[0]);
	...
	aFormData.append("mobile", localStorage.getItem("usernamewindmills"));
    aFormData.append("brand", "windmills");
	...
	$.ajax(
    {
      ...
      success     : 
        function(data)
        {
         ...
         document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/windmills_'+localStorage.getItem("username")+'.jpg';
      //   document.getElementById("cardImage").src='http://103.25.128.61:9296/mloyalfileupload/uploads/windmills_'+localStorage.getItem("username")+'.jpg';
        }
    });
...
function gotobuyMembership()
{
	...
	{
		$.mobile.changePage( "#buymembership", { transition: "none"} );
	}
}

function gototopupMembership()
{
	if(user.mobile==null || user.mobile=='')
	{
		$.mobile.changePage( "#myaccount", { transition: "none"} ); 
	...
	{
		$.mobile.changePage( "#topupmembership", { transition: "none"} );
	}
}

function buyMembership()
{
	toast2('PURCHASES AND TOP-UPS ARE NON-REFUNDABLE');

	var mtype=$('input[name="sel_membership"]:checked').val();
	...
	else if(mtype=='blue')
	{
 	...
 	{
 		toast('Please select membership type');
 	}
 	else
 	{
 		$.ajax({
		   url: PHPSERVER+'checkout',
		   type: 'GET',
		   timeout: 50000,
		   data: {
						'products': mtype,
						'payamt': amt,
						'fname': checkforundefined(user.firstname),  
						'lname': checkforundefined(user.lastname),
						'email': checkforundefined(user.emailid), 
						'phone': user.mobile,
						'paytype': 'paytm'
			...
			success: function(data, textStatus, xhr) {
				...
				console.log('JSONDATA in submit:'+JSON.stringify(data));
...
function topupMembership()
{
	...
	var denomination = $('#topup_denomination').val();

	console.log('denomination amt:'+denomination);

 	if(typeof denomination == undefined || denomination == null || denomination =='' || denomination =='undefined' || denomination =='null')
 	{
 		toast('Please select top up value');
 	}
 	else
 	{
 		$.ajax({
...
function checkStatus()
{
 ...
 $.ajax({
			...
			url: PHPSERVER+'getcat/getSubscription?mobile='+user.mobile,
            type: 'GET',
			timeout: 300000,
            dataType: "json",
		   ...
		   //called when complete
			...
			success: function(data, textStatus, xhr) {
				...
				console.log('JSONDATA checkStatus:'+JSON.stringify(data));
...
function showpopupColor(type)
{
	  console.log(type);

	  if (type == 'green') 
	  {
			$("#mtype_colorpoup1").popup();
			$("#mtype_colorpoup1").popup("open"); 
	  }
	  else if (type == 'orange') 
	  {
			$("#mtype_colorpoup2").popup();
			$("#mtype_colorpoup2").popup("open"); 
	  }
	  else if (type == 'blue')
	  {
			$("#mtype_colorpoup3").popup();
			$("#mtype_colorpoup3").popup("open"); 
	  }
...
function showmyProfile()
{
	...
	else
	{
        ...
        $('#update_firstname_new').val(user.firstname);
		$('#update_lastname_new').val(user.lastname);
		$('#update_mobile_new').val(user.mobile);
		$('#update_email_new').val(user.emailid);

		/* setting dob */
		var dt1 = user.dob;
		var dt2 = dt1.split("-");
		//user.dob = yyyy+ "-" +mm+ "-" + dd;
		//user.dob = dt2[2]+"-"+dt2[1]+"-"+dt2[0];
		$('#update_dob_new').val(dt2[2]+"-"+dt2[1]+"-"+dt2[0]);
		...
		$.mobile.changePage( "#myprofilepg", { transition: "none"} );
	}
}
...
function capturePhotonew()
{
	...
	else
	{
				...
				navigator.camera.getPicture(onPhotoDataSuccessnew, onFail, { quality: 40,
...
function onPhotoDataSuccessnew(imageURI) 
{
				...
				var fName ='windmills_'+localStorage.getItem("usernamewindmills");
				...
				var ft = new FileTransfer();
				localStorage.setItem('imagedata',filenmdoc);
				...
				ft.upload(imageURI, encodeURI("https://taghash.co/mloyalfileupload/fileupload1.php"), winnew, failnew, options, true);
}
...
function winnew(r) 
{
    ...
    statusDomdiv=document.getElementById("profile_photo_status_div");
	statusDomdiv.style.display = 'none';
